...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h1 class="h2 d-flex justify-content-between w-100">
            {{lang('admin.news')}}
            <a href="{{aurl('news/create')}}" class="btn btn-primary">{{lang('cat.create')}}</a>
        </h1>
    </div>
        ...
        <table class="table table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th scope="col">{{lang('admin.user_id')}}</th>
                    <th scope="col">{{lang('admin.category_id')}}</th>
                    <th scope="col">{{lang('news.description')}}</th>
                    <th scope="col">{{lang('news.image')}}</th>
                    <th scope="col">{{lang('news.content')}}</th>
                    <th scope="col">{{lang('news.created_at')}}</th>
                    <th scope="col">{{lang('news.updated_at')}}</th>
